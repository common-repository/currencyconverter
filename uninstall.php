...
delete_option( 'widget_' . \Korobochkin\CurrencyConverter\Plugin::NAME . '_minimalistic' );
delete_option( 'widget_' . \Korobochkin\CurrencyConverter\Plugin::NAME . '_minimalistic_ver2' );
delete_option( 'widget_' . \Korobochkin\CurrencyConverter\Plugin::NAME . '_table' );
